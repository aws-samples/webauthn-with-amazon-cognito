...
var ChaCha20 = (function (_super) {
    tslib_1.__extends(ChaCha20, _super);
    function ChaCha20() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
...
var Des = (function (_super) {
    tslib_1.__extends(Des, _super);
    function Des() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Des.checkKeyUsages = function (keyUsages) {
        var _this = this;
        _super.checkKeyUsages.call(this, keyUsages);
        var wrongUsage = keyUsages.filter(function (usage) { return _this.KEY_USAGES.indexOf(usage) === -1; });
        if (wrongUsage.length) {
    ...
    Des.checkAlgorithm = function (alg) {
        if (alg.name.toUpperCase() !== this.ALG_NAME.toUpperCase()) {
            throw new AlgorithmError(AlgorithmError.WRONG_ALG_NAME, alg.name, this.ALG_NAME);
        }
    };
    Des.checkKeyGenParams = function (alg) {
        if (!("length" in alg)) {
    ...
    Des.generateKey = function (algorithm, extractable, keyUsages) {
        var _this = this;
    ...
    Des.exportKey = function (format, key) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.checkKey(key, _this.ALG_NAME);
            _this.checkFormat(format, key.type);
    ...
    Des.importKey = function (format, keyData, algorithm, extractable, keyUsages) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.checkAlgorithm(algorithm);
            _this.checkFormat(format);
    ...
    Des.wrapKey = function (format, key, wrappingKey, wrapAlgorithm) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.checkAlgorithmParams(wrapAlgorithm);
            _this.checkKey(wrappingKey, _this.ALG_NAME, "secret", "wrapKey");
    ...
    Des.unwrapKey = function (format, wrappedKey, unwrappingKey, unwrapAlgorithm, unwrappedKeyAlgorithm, extractable, keyUsages) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.checkAlgorithmParams(unwrapAlgorithm);
            _this.checkKey(unwrappingKey, _this.ALG_NAME, "secret", "unwrapKey");
    ...
    Des.encrypt = function (algorithm, key, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.checkAlgorithmParams(algorithm);
            _this.checkKey(key, _this.ALG_NAME, "secret", "encrypt");
    ...
    Des.decrypt = function (algorithm, key, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.checkAlgorithmParams(algorithm);
            _this.checkKey(key, _this.ALG_NAME, "secret", "decrypt");
    ...
    Des.ALG_NAME = "";
    Des.KEY_LENGTH = 64;
    Des.KEY_USAGES = ["encrypt", "decrypt", "wrapKey", "unwrapKey"];
    return Des;
}(BaseCrypto));
var DesCBC = (function (_super) {
    tslib_1.__extends(DesCBC, _super);
    function DesCBC() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DesCBC.checkAlgorithmParams = function (alg) {
        this.checkAlgorithm(alg);
        if (!alg.iv) {
    ...
    DesCBC.ALG_NAME = AlgorithmNames.DesCBC;
    return DesCBC;
}(Des));
var DesEdeCBC = (function (_super) {
    tslib_1.__extends(DesEdeCBC, _super);
    function DesEdeCBC() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DesEdeCBC.ALG_NAME = AlgorithmNames.DesEdeCBC;
    DesEdeCBC.KEY_LENGTH = 192;
    return DesEdeCBC;
}(DesCBC));
...
var EdDSA = (function (_super) {
    tslib_1.__extends(EdDSA, _super);
    function EdDSA() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
        ...
        return Promise.resolve()
            ...
            switch (derivedKeyType.name.toUpperCase()) {
                ...
                case AlgorithmNames.DesCBC:
                    DesCBC.checkKeyGenParams(derivedKeyType);
                    DesCBC.checkKeyUsages(keyUsages);
                    break;
                case AlgorithmNames.DesEdeCBC:
                    DesEdeCBC.checkKeyGenParams(derivedKeyType);
...
var Poly1305 = (function (_super) {
    tslib_1.__extends(Poly1305, _super);
    function Poly1305() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
